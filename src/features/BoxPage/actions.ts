...
export const getGlobalBalance = createAsyncThunk('boxPage/getGlobalBalane', async () => {
...
export const storeBox = createAsyncThunk('boxPage/storeBox', async (data: { name: string }, { rejectWithValue }) => {
  try {
...
export const mountGlobalTransactions = createAsyncThunk('boxPage/mountGlobalTransactions', async () => {
...
export const storeTransaction = createAsyncThunk(
  ...
  async (data: IStoreTransactionRequest, { rejectWithValue }) => {
    const url = data.boxId ? `/cashboxes/minors/${data.boxId}/transactions` : `/cashboxes/main/transactions`;
...
export const showCashTransferForm = createAction('boxPgae/showCashTransferForm');
export const hideCashTransferForm = createAction('boxPage/hideCashTransferForm');
